...
void CDInput::SI_ReadMeshTallyCard(bool &bIsBlockEnd,vector<CDMeshTally> &vMeshTally,bool &bIsWithMeshTally)
{
	...
	SI_ReadCardOptions(string("MESHTALLY"),vOptions,vParaNum,vParas,bIsBlockEnd);
