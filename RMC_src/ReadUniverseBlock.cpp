...
void CDInput::ReadUniverseBlock(CDGeometry &cGeometry)
{
	...
	bool bIsBlockEnd;
	ReadCardOptions(string("UNIVERSE"),vOptions,vParaNum,vParas,bIsBlockEnd);
	...
	{
		ReadCellCard(nUniv_index,cGeometry);
